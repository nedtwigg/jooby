...
/**
 * Implementation of Router which creates Routes but does not
 * track them.  Allows for code such as the following:
 *
 * <pre>
 * public class ArticleModule implements Jooby.Module {
 *   static final Route.Definition USER_TITLE = NoOpRouter.caseSensitive().get("/:user/:title");
 *
 *   @Override
 ...
 * </pre>
 *
 * The advantage of this style is that you can easily refactor
 * routes because they are only defined in one place.
 *
 * @author edgar
 * @since 1.2.0
 */
